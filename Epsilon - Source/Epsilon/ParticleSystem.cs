...
namespace Epsilon
{
    public sealed class ParticleSystem : StageObject
    {
        ...
        public ParticleSystem(Stage stage) : base(stage)
        {
            _particleTexture = Texture2D.FromFile(Epsilon.GraphicsDevice, @"D:\C# Windows Apps\Epsilon\Epsilon - Source\Old Code\Default\Assets\Textures\Item Textures\Player.png");
        }
