...
namespace EpsilonEngine
{
    ...
    {
        public static Texture Blitz(Texture source, Texture destination, Point position)
        {
        ...
        public static Texture SubTexture(Texture source, PointRect sourceRectangle)
        {
