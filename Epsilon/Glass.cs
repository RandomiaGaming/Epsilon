...
namespace Epsilon
{
    public sealed class Glass : PhysicsObject
    {
        public Glass(StagePlayer stagePlayer, PhysicsLayer physicsLayer, PhysicsLayer[] collsionPhysicsLayers, Texture groundTexture) : base(stagePlayer, physicsLayer)
        {
